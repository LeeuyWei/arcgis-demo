<template>
  <div class="final-wrap">
    ...
    <div id="mapWrap"></div>
    <div class="slide-bar right-wrap"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initMap() {
      ...
      this.sView.ui._removeComponents(['zoom']);
      // eslint-disable-next-line no-underscore-dangle
      this.sView.ui._removeComponents(['navigation-toggle']);
      // eslint-disable-next-line no-underscore-dangle
      this.sView.ui._removeComponents(['compass']);
      this.sView.when(() => {
        this.drawDistrict();
      });
    },
